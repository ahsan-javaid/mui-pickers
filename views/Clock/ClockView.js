...
var TimeView_1 = require("./TimeView");
exports.ClockView = function (_a) {
    ...
    return React.createElement(TimeView_1.TimeView, __assign({ date: date, onMinutesChange: onMinutesChange, type: type, ampm: ampm, minutesStep: minutesStep }, viewProps));
};
